 ...
 */
final class Version20240405073152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, club_id INT NOT NULL, national_id INT NOT NULL, nom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, nationalite VARCHAR(255) NOT NULL, nombre_but INT NOT NULL, INDEX IDX_98197A6561190A32 (club_id), INDEX IDX_98197A6536491297 (national_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
